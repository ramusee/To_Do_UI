...
const BTN_ADD_HIGH = _viewJs.UI_ELEMENTS.SECTION_HIGH.children[1][1];
const BTN_ADD_LOW = _viewJs.UI_ELEMENTS.SECTION_LOW.children[1][1];
BTN_ADD_HIGH.addEventListener('click', addTaskHigh);
BTN_ADD_LOW.addEventListener('click', addTaskLow);
function addTaskHigh() {
    const INPUT_VALUE = _viewJs.UI_ELEMENTS.SECTION_HIGH.children[1][0].value;
    const nowDate = _dateFns.format(new Date(), 'dd.MM.yyyy');
    if (INPUT_VALUE !== '') _viewJs.UI_ELEMENTS.TASKS_HIGH.insertAdjacentHTML('afterbegin', `<div class="todo__task">
    ...
    _viewJs.UI_ELEMENTS.FORM_HIGH.reset();
}
function addTaskLow() {
    const INPUT_VALUE = _viewJs.UI_ELEMENTS.SECTION_LOW.children[1][0].value;
    const nowDate = _dateFns.format(new Date(), 'dd.MM.yyyy');
    if (INPUT_VALUE !== '') _viewJs.UI_ELEMENTS.TASKS_LOW.insertAdjacentHTML('afterbegin', `<div class="todo__task">
      <input class="task__check-input" type="checkbox">
      <span class="task__checkbox"></span>
      <p class="task__text"></p>
      <div class="task__container">
    ...
    _viewJs.UI_ELEMENTS.FORM_LOW.reset();
}
function changeStatus() {
    this.parentElement.children[0].checked === true ? this.parentElement.style.backgroundColor = '#f4f4f4' : this.parentElement.style.backgroundColor = '#fff';
}
function deleteTask() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aIdiY","bDbGG"], "bDbGG", "parcelRequire9ca6")
